...
public class Invoice {
    ...
    private static final String AMOUNT = "amount";*/
        ...
        private String date;
        private int amount,remaining,bookmark,type;

        public Wallet(String title, String description, String date, int amount,int remaining, int bookmark,int type) {
            this.title = title;
    ...
    private static final String AMOUNT = "amount";*/
        ...
        public Balance(String date, int amount,float remaining,String description) {
            this.date = date;
            this.amount = amount;
            this.remaining = remaining;
            this.description = description;
