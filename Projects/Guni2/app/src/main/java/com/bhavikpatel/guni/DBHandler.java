    ...
    public static class DBIncoice extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            query = "CREATE TABLE " + TableWallet.NAME +
                    ...
                    TableWallet.COLUMN_REMAINING + " INTEGER," +
            ...
            query = "CREATE TABLE " + TableBalance.NAME +
                    ...
                    TableBalance.COLUMN_REMAINING + " INTEGER," +
        ...
        public class TableWallet {
            ...
            public ArrayList<Invoice.Wallet>  getList(){
                ...
                while(!c.isAfterLast()){
                    ...
                    walletInvoice.setRemaining(c.getInt(c.getColumnIndex(COLUMN_REMAINING)));
            ...
            public void addIncoice(Invoice.Wallet invoice){
                ...
                values.put(COLUMN_REMAINING,invoice.getRemaining());
        ...
        public class TableBalance {
            ...
            static final String COLUMN_REMAINING = "remaining";
            ...
            public ArrayList<Invoice.Balance>  getList(){
                ...
                while(!c.isAfterLast()){
                    ...
                    balanceInvoice.setRemaining(c.getInt(c.getColumnIndex(COLUMN_REMAINING)));
            ...
            public void addIncoice(Invoice.Balance invoice){
                SQLiteDatabase db = getWritableDatabase();
                ContentValues values = new ContentValues();
                values.put(COLUMN_AMOUNT,invoice.getAmount());
                values.put(COLUMN_REMAINING,invoice.getRemaining());
